                ...
                <div className="space-y-4">
                    {archivedSessions.map((session) => {
                        ...
                        return (
                            <div
                                key={session.id}
                                className="card p-6 hover:border-[var(--border-secondary)] transition-colors"
                            >
                                <div className="flex items-center gap-4">
                                    {/* Product Icon */}
                                    <div className={`w-12 h-12 rounded-xl bg-[var(--bg-input)]/50 flex items-center justify-center ${colorClass}`}>
                                        <ProductIcon size={24} />
                                    </div>
